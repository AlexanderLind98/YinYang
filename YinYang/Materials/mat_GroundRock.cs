...
/// </summary>
public class mat_GroundRock : Material
{
    public mat_GroundRock() : base()
    {
        uniforms.Add("material.diffTex", new Texture("Textures/GroundRock_Diff.jpg"));
        uniforms.Add("material.specTex", new Texture("Textures/GroundRock_Spec.jpg"));
        uniforms.Add("material.normTex", new Texture("Textures/GroundRock_Norm.jpg"));
