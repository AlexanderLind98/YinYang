...
/// </summary>
public class mat_MossRock01 : Material
{
    public mat_MossRock01() : base()
    {
        uniforms.Add("material.diffTex", new Texture("Textures/MossRock01_Diff.jpg"));
        uniforms.Add("material.specTex", new Texture("Textures/MossRock01_Spec.jpg"));
        uniforms.Add("material.normTex", new Texture("Textures/MossRock01_Norm.jpg"));
