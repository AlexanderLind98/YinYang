...
/// </summary>
public class mat_MossRock02 : Material
{
    public mat_MossRock02() : base()
    {
        uniforms.Add("material.diffTex", new Texture("Textures/MossRock02_Diff.jpg"));
        uniforms.Add("material.specTex", new Texture("Textures/MossRock02_Spec.jpg"));
        uniforms.Add("material.normTex", new Texture("Textures/MossRock02_Norm.jpg"));
